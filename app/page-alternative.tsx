  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-black">
      ...
      <div className="absolute top-6 left-6 z-30 flex items-center">
        <Bed className="h-5 w-5 text-amber-300" />
        <span className="ml-2 text-xs font-light tracking-widest text-white/90">ELYSIAN</span>
      </div>
      ...
      <div className="relative z-20 w-full max-w-4xl px-4 text-center">
        ...
        >
          <Link
            href="https://your-external-form-url.com"
            target="_blank"
      ...
      <div className="absolute bottom-4 left-0 right-0 z-30 flex items-center justify-center space-x-2 text-[10px] text-white/70">
        <span>© 2025 ELYSIAN BOUTIQUE HOTEL</span>
        <span className="text-amber-300/70">•</span>
        <span>42 MADISON AVENUE, NEW YORK, NY 10010</span>
      </div>
